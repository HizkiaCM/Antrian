  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Menu Utama Aplikasi Antrian RSUP Persahabatan</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm">
              <div class="card-body p-5">
                ...
                <h3>Tampilan</h3>
                <a href="ini-video/index2.php" class="btn btn-success rounded-pill px-4 py-2">
                  Tampilkan <i class="bi-chevron-right ms-2"></i>
                </a>
              </div>
            </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2023 - <a href="https://www.ftek.uksw.edu/" target="_blank" class="text-danger text-decoration-none">www.ftek.uksw.edu</a>. All rights reserved.
      </div>
    </div>
  </footer>
